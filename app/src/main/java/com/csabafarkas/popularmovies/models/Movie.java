...
public class Movie implements Parcelable
{
    ...
    protected Movie(Parcel in) {
        ...
        in.readList(this.productionCompanies, (com.csabafarkas.popularmovies.models.ProductionCompany.class.getClassLoader()));
        in.readList(this.productionCountries, (com.csabafarkas.popularmovies.models.ProductionCountry.class.getClassLoader()));
        this.releaseDate = ((String) in.readValue((String.class.getClassLoader())));
        this.revenue = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.runtime = ((Integer) in.readValue((Integer.class.getClassLoader())));
        in.readList(this.spokenLanguages, (com.csabafarkas.popularmovies.models.SpokenLanguage.class.getClassLoader()));
